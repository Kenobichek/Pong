...
set(SDL2_LIBRARIES      SDL2::SDL2main SDL2::SDL2 SDL2::SDL2_ttf SDL2::SDL2_image)
...
set(_sdl2ttf_library "${SDL2_LIBDIR}/SDL2_ttf.lib")
if(EXISTS "${_sdl2ttf_library}")
    ...
    set(SDL2_SDL2_ttf_FOUND TRUE)
else()
    set(SDL2_SDL2_ttf_FOUND FALSE)
endif()
unset(_sdl2ttf_library)

set(_sdl2image_library "${SDL2_LIBDIR}/SDL2_image.lib")
if(EXISTS "${_sdl2image_library}")
    ...
    set(SDL2_SDL2_image_FOUND TRUE)
else()
    set(SDL2_SDL2_image_FOUND FALSE)
endif()
